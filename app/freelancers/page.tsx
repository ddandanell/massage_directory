            ...
            <div className="relative py-12 md:py-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 relative">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 max-w-2xl leading-relaxed">
                        ...
                        Filter by location, treatment type, or search for your favorite therapist. Prefer the convenience of treatments at your villa? Check out <a href="https://homemassageubud.com/" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30 hover:decoration-emerald-300 transition-colors">home massage options in Ubud</a>.
                    </p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="lg:sticky lg:top-24">
                            ...
                            <div className="mt-6 p-4 md:p-6 bg-teal-900/10 border border-teal-900/20 rounded-2xl md:rounded-3xl">
                                ...
                                <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                                    Prefer massage at your location? Our partners offer <a href="https://homemassageubud.com/" target="_blank" rel="noopener noreferrer" className="text-teal-400 hover:text-teal-300 underline decoration-teal-400/30 hover:decoration-teal-300 transition-colors">mobile massage services throughout Ubud</a>.
                                </p>
                            </div>
                        </div>
                    </div>
